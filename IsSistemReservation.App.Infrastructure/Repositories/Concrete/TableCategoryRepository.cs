...
{
	public class TableCategoryRepository : Repository<TableCategory>, ITableCategoryRepository
	{
		public TableCategoryRepository(AppDbContext dbContext) : base(dbContext)
		{
		}
	}
}
